...
@click.command()
@click.option("--pretrained_ckpt", type=str, default="/root/GUIDE/GUIDE/ffhqrebalanced512-128.pkl")
...
def main(pretrained_ckpt, ckpt, exp, num_samples, batch_size, seed, angle_p, angle_y_abs, truncation, truncation_cutoff):
    ...
    fake_image_ours_path = f"/root/autodl-tmp/fake_images/{exp}"
    fake_image_pretrained_path = f"/root/autodl-tmp/fake_images/pretrained/{seed}"
    ...
    ffhq_feat_path = "/root/GUIDE/GUIDE/ffhq_real_feat.npy"
